...
if (isset($_POST['sign_up'])) {
    ...
    $user_cat_id = mysqli_real_escape_string($con, $_POST['u_year']);
    $discipline = mysqli_real_escape_string($con, $_POST['u_disc']);
    $phone_no = mysqli_real_escape_string($con, $_POST['u_phone']);
    $reg_no = mysqli_real_escape_string($con, $_POST['u_reg']);
    $shift = mysqli_real_escape_string($con, $_POST['u_shift']);
    $semester = mysqli_real_escape_string($con, $_POST['u_semester']);
    ...
    $insert2 = "insert into user_details (discipline,phone_no,reg_no,shift,semester) values ('$discipline', '$phone_no', '$reg_no', '$shift', '$semester')";
