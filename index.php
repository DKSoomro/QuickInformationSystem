...
<div class="top">
	<div class="container-fluid"> <!-- container-fluid start here -->
		...
		<div class="col-lg-6 left-corner text-white"> <!-- left-corner for email and phone-no start here -->
			<i class="fa fa-envelope-o email-icon" aria-hidden="true"></i><a class="email" href="#">director@usindh.edu.pk</a>
		...
		<div class="col-lg-6 right-corner text-white"> <!-- right-corner for sign-up and log-in start here -->
			<i class="fa fa-user-plus signup-icon" aria-hidden="true"></i><a class="signup" href="signup.php">SIGN UP</a>
			<i class="fa fa-unlock-alt login-icon" aria-hidden="true"></i><a class="login" href="login.php">LOGIN</a>
...
<nav class="navbar navbar-expand-lg navbar-light home-nav">
  	<div class="container"> <!-- container strat here -->
  		<a class="navbar-brand" href="homepage.html"><img class="img-fluid logo" src="assets/images/homepage-logo2.png"></a> <!-- logo img -->
  ...
  <div class="carousel-inner">
    <div class="carousel-item active"> <!-- img1 start here -->
      ...
      <div class="carousel-caption homeslider-caption1"> <!-- Slider inner caption1 start here -->
	    <h5 class="homeslider-text1">INSTITUTE OF INFORMATION & COMMUNICATION <br> TECHNOLOGY</h5>
	     <p class="home-shortcap1"> university of sindh jamshoro </p>
    ...
    <div class="carousel-item"> <!-- img2 start here -->
      ...
      <div class="carousel-caption homeslider-caption2"> <!-- Slider inner caption2 start here -->
	    <h5 class="homeslider-text2">NOTIFICATION, ASSIGNMENTS & CHAT SERVICE <br> WEB APPLICATION</h5>
	     <p class="home-shortcap2"> final year project 2020 </p>
	...
	<div class="row">
		...
		<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
			...
			<div class="home-softdeprt">
				...
				<a class="SoftEng" href="#"><h4 class="soft">Software</h4>
		...
		<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
			...
			<div class="home-eledeprt">
				...
				<a class="EleEng" href="#"><h4 class="ele">Electronics</h4>
				<h6 class="ele-eng">Engineering</h6></a>
			</div>
			</center>
		</div>
		<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				<h1 class="about-iict">Director of IICT</h1>
	...
	<h1 class="meet-professionals">Meet Professionals</h1>
		...
		<div class="row staff-half1"> <!-- staff-half1 start here -->
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 staff1">
				<img class="img-fluid" src="assets/images/staffimg1.png">	
			</div>

			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 staff2">
				<h4 class="home-teacherName1">Dr Zeeshan Bhatti</h4>
				<h6 class="home-teachtitle1">Assistant Professor</h6>
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 staff3">
				<img class="img-fluid" src="assets/images/staffimg2.png">	
			</div>

			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 staff4">
				<h4 class="home-teacherName2">Dr Kamran Taj Pathan</h4>
				<h6 class="home-teachtitle2">Professor</h6>
				<div class="iconsforteacher">
				<a href="#"><i class="fa fa-facebook fbicon" aria-hidden="true"></i></a>
				<a href="#"><i class="fa fa-twitter twiticon" aria-hidden="true"></i></a>
				<a href="#"><i class="fa fa-linkedin inicon" aria-hidden="true"></i></a>
...
<br><br>
		<div class="row staff-half2"> <!-- staff-half1 start here -->
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 staff5">
				<img class="img-fluid" src="assets/images/staffimg3.png">	
			</div>

			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 staff6">
				<h4 class="home-teacherName3">Mr Ghulam Mustafa Shoro</h4>
				<h6 class="home-teachtitle3">Assistant Professor</h6>
				<div class="iconsforteacher">
				<a href="#"><i class="fa fa-facebook fbicon" aria-hidden="true"></i></a>
				<a href="#"><i class="fa fa-twitter twiticon" aria-hidden="true"></i></a>
				<a href="#"><i class="fa fa-linkedin inicon" aria-hidden="true"></i></a>
			...
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 staff7">
				<img class="img-fluid" class="staffimg4" src="assets/images/staffimg4.jpg">	
			</div>

			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 staff8">
				<h4 class="home-teacherName4">Dr Dil Nawaz  Hakro </h4>
				<h6 class="home-teachtitle4">Assistant Professor</h6>
				<div class="iconsforteacher">
				<a href="#"><i class="fa fa-facebook fbicon" aria-hidden="true"></i></a>
				<a href="#"><i class="fa fa-twitter twiticon" aria-hidden="true"></i></a>
				<a href="#"><i class="fa fa-linkedin inicon" aria-hidden="true"></i></a>
	...
	<div class="row events&news-row">
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 newspart4">
			...
			<div class="upcomingevent-text1">
				...
				<i class="coming-locationicon1 fa fa-map-marker" aria-hidden="true"></i><h4 class="location1">UOS,IICT</h4>
			</div>
			<div class="upcomingevent-text2">
				...
				<i class="coming-locationicon2 fa fa-map-marker" aria-hidden="true"></i><h4 class="location2">UOS,IICT</h4>
			</div>
			<div class="upcomingevent-text3">
				...
				<i class="coming-locationicon3 fa fa-map-marker" aria-hidden="true"></i><h4 class="location3">UOS,IICT</h4>
			</div>
		</div>
...
<div class="Footer">
	<div class="container-fluid">
		<img class="footerlogo-img img-fluid" src="assets/images/footer-logo.png">
		<div class="row">
